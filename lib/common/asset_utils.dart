class AssetUtilities {
  ...
  static String wait = '${gifRoot}wait.gif';

  static String svgRoot = "assets/images/svg/";
  static String explore = '${svgRoot}explore.svg';
  static String bookmark = '${svgRoot}bookmark.svg';
  static String profile = '${svgRoot}profile.svg';
  static String news = '${svgRoot}news.svg';
  static String home = '${svgRoot}home.svg';
}
